...
import { Home, CreditCard, PiggyBank, TrendingUp, ArrowUpRight, ArrowDownRight, PieChart, BarChart3, MessageCircle, Calendar, ChevronRight, Shield } from 'lucide-react';
